...
define('dummy/pods/components/options-table/template', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      statements: [
        ["block","ember-markdown-section",[],[],0,null,["loc",[null,[1,4],[27,31]]]]
      ],
      locals: [],
      templates: [child0]
    };
...
if (runningTests) {
  ...
  require("dummy/app")["default"].create({"name":"ember-searchable-select","version":"v0.8.0"});
}
