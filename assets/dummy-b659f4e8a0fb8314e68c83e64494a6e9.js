    ...
    var child0 = (function() {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("The search text is sent as an argument. Useful for custom filtering or AJAX search. The component's internal filter is automatically disabled when an on-search action is \n    provided.     | Ember action    | Ember.K\n    isLoading                 | Pass in your own boolean flag to toggle visibility of a loading animation.     | boolean     | false\n    loadingMessage            | Text to displayed beside the loading animation when `isLoading` is true.    | string    | 'Searching...'\n    on-close                  | Specify your own named action to trigger when the menu closes. Useful hook for clearing out content that was previously passed in with AJAX. | Ember action | Ember.K\n\n\n");
          dom.appendChild(el0, el1);
          return el0;
        },
        buildRenderNodes: function buildRenderNodes() { return []; },
...
if (runningTests) {
  ...
  require("dummy/app")["default"].create({"name":"ember-searchable-select","version":"v0.9.0"});
}
