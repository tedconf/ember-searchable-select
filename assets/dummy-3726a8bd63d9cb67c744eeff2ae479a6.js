  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      statements: [
        ...
        ["inline","examples/example-disabled",[],["TEDevents",["subexpr","@mut",[["get","TEDevents",["loc",[null,[37,40],[37,49]]]]],[],[]]],["loc",[null,[37,2],[37,51]]]],
        ["inline","examples/word-boundary",[],["TEDevents",["subexpr","@mut",[["get","TEDevents",["loc",[null,[38,37],[38,46]]]]],[],[]]],["loc",[null,[38,2],[38,48]]]],
        ["inline","examples/ajax-search",[],["TEDevents",["subexpr","@mut",[["get","TEDevents",["loc",[null,[39,35],[39,44]]]]],[],[]]],["loc",[null,[39,2],[39,46]]]],
...
define('dummy/pods/components/examples/two-way-bound/component', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember['default'].Component.extend({
    ...
    changeToOption: Ember['default'].computed('TEDevents', function () {
      return this.get('TEDevents').findBy('title', 'TED2014');
    }),
    actions: {
      clearFromOutside: function clearFromOutside() {
        this.set('selectedOption', null);
      },
      changeFromOutside: function changeFromOutside() {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      statements: [
        ...
        ["element","action",["clearFromOutside"],[],["loc",[null,[23,10],[23,39]]]],
        ["element","action",["changeFromOutside"],[],["loc",[null,[24,10],[24,40]]]]
      ],
      locals: [],
      templates: [child0]
    };
...
if (runningTests) {
  ...
  require("dummy/app")["default"].create({"name":"ember-searchable-select","version":"v0.1.1"});
}
